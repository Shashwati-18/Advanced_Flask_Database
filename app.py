...
def add_sample_student():
    """Add 5 different sample students"""
    conn = get_db_connection()
    
    # List of 5 students
    students = [
        ('Alice Smith', 'alice@example.com', 'Data Science'),
        ('Bob Johnson', 'bob@example.com', 'AI & ML'),
        ('Charlie Brown', 'charlie@example.com', 'Web Development'),
        ('David Lee', 'david@example.com', 'Python'),
        ('Eva Green', 'eva@example.com', 'Cybersecurity')
    ]
    
    # Insert all students one by one
    ...
    conn.commit()
    conn.close()
    return '5 Students added! <a href="/">Go back to home</a>'
